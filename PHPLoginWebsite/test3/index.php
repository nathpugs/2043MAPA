...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="articles.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">ARTICLES</a>
...
<a href="articles.php" class="w3-bar-item w3-button w3-padding-large">ARTICLES</a>
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
    ...
    <h2 class="w3-wide">THE TEAM</h2>
      ...
      <div class="w3-third">
       <img src="images/charles.png" class="w3-round"  style="width:60%">
          <p><b>Charles Mugisha</b><br><i>In the first we get too comfortable and forget that the world is a lot harder and scarier than our man made “safe spaces”. A great number of people in the world are really struggling to feed their families, find homes or even get proper medical attention. We must remember how good we have. Of course some members of society have it way better than the majority and unfortunate this is just the reality of the world. Sure feelings are important because and serious social issues should be talked head on but we must not clump personal issues with actual political issue. It would be a shame to march back the progress that we made.</i></p>
      </div>
      <div class="w3-third">
 ...
 <form method="post" action="q1yes.php">
  <input type="submit" name="yes" value="OUTRAGED" style="cursor: pointer;"> 
</form>
    
<form method="post" action="q1maybe.php">
  <input type="submit" name="maybe" value="SLIGHTLY OUTRAGED" style="cursor: pointer;"> 
</form>
    
<form method="post" action="q1no.php">
  <input type="submit" name="no" value="NOT OUTRAGED" style="cursor: pointer;"> 
</form>    
    </div>
  </div>
